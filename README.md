...
### Running with a Jenkinsfile

Generally, the same syntax works with Jenkinsfiles. However, change the base test as follows:
...
Here's one configuration to test with.

```groovy
/*
 * Initially, this file was generated by the Gradle 'init' task.
 */
...
dependencies {
    ...
    // Test the Jenkinsfile with JenkinsPipelineUnit
    testCompile 'com.lesfurets:jenkins-pipeline-unit:1.1'
}
